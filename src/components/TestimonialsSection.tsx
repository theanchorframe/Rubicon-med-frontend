...
const TestimonialsSection = () => {
  ...
  const testimonials = [
    {
      headline: "200+ Sales Reps Trained. 5,000 Clinics Targeted. Goals Exceeded in Year One.",
      ...
      author: "Barry R. Hix, MBA, MPH",
      title: (
        <>
          Executive Vice President, EMPI
          <br />
          <span className="italic">(Executive Sponsor / Skip-Level Direct)</span>
        </>
      ),
    },
    {
    ...
    {
      headline: "The Rare Combination of Sales Management Experience and Marketing Intelligence",
    ...
    {
      headline: "Always Asked the Right Questions and Always Showed Up to Solve the Problem",
    ...
    >
      <div className="container mx-auto px-4">
        <motion.h2
          ...
          viewport={{ once: true }}
          className="text-3xl md:text-4xl lg:text-[2.75rem] xl:text-5xl font-bold text-navy text-center mb-4 px-2 max-w-6xl mx-auto leading-tight pb-2"
        >
          The Track Record Behind Rubicon: What Industry Leaders Say About Working With Rob
        </motion.h2>
