  ...
  return (
    <div className="relative overflow-hidden bg-navy text-navy-foreground">
      ...
      <div
        ...
        style={{
          background: "radial-gradient(ellipse 80% 60% at 20% 30%, rgba(255,255,255,0.06) 0%, transparent 70%)",
        }}
      />
      <div
        className="absolute inset-0 animate-drift-2"
        style={{
          background: "radial-gradient(ellipse 70% 80% at 75% 60%, rgba(255,255,255,0.05) 0%, transparent 70%)",
        }}
      />
      <div
        className="absolute inset-0 animate-drift-3"
        style={{
          background: "radial-gradient(ellipse 60% 50% at 50% 80%, rgba(255,255,255,0.04) 0%, transparent 70%)",
        }}
      />
