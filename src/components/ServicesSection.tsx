...
const ServicesSection = ({ onOpenConsultationDialog }: ServicesSectionProps) => {
  ...
  const services = [
  {
    ...
    description:
    "Our proven framework integrates multidimensional technical, clinical, and R&D due diligence with rigorous market modeling. We synthesize competitive intelligence and growth drivers to ensure capital is deployed only into assets with a validated path to market leadership."
  },
  {
    title: "Clinical & Market Research",
    boldOpener: "Every investment decision backed by evidence, not assumptions",
    description:
    "Drive confident product investment through clinical, R&D, and market triangulation. We leverage expert consultations and comprehensive database analytics to distill complex evidence into an actionable roadmap – eliminating market ambiguity and securing your path to success."
  },
  {
    ...
    <section id="services" className="py-20 bg-background scroll-mt-20">
      <div className="container mx-auto px-4">
        <motion.h2
          ...
          viewport={{ once: true }}
          className="sm:text-3xl md:text-[2.5rem] lg:text-[3rem] font-bold text-navy text-center mb-4 px-2 text-3xl" style={{ lineHeight: '1.4' }}>Six Ways Rubicon Turns <span className="text-primary">Clinical and Market Intelligence</span> Into Defensible Commercial Decisions
