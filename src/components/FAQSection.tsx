  ...
  const faqs = [
    {
      ...
      answer:
        "<strong>Earlier the better.</strong> The team has worked with companies at the product ideation stage, using KOL research, market sizing, and competitive analysis to validate the concept before commitments are made through active launch planning, when launch strategy and tactics needed sharper validation before going to market. If a market decision is on the table, the conversation is worth having.",
    },
    {
