        ...
        >
          <div className="space-y-4">
            ...
            <motion.h1
              ...
              className="text-4xl md:text-5xl lg:text-6xl font-bold text-white text-center leading-relaxed my-8 max-w-4xl mx-auto"
            >
            ...
            <motion.p
              ...
              className="mx-auto font-medium text-center mb-12 max-w-3xl leading-relaxed"
              style={{
            ...
            >
              <Button
                ...
                className="bg-primary text-primary-foreground hover:bg-primary/90 max-w-full whitespace-normal text-center leading-tight h-auto px-6 py-4 sm:px-8"
              >
