    ...
    <section className="py-16 bg-accent scroll-mt-20" id="case-study">
      <div className="container mx-auto px-4">
        <motion.div
          ...
          viewport={{ once: true }}
          className="max-w-4xl mx-auto bg-accent rounded-2xl overflow-hidden p-6 md:p-8 lg:p-12"
        >
          <div className="space-y-6 text-center">
            ...
            <div className="w-full max-w-2xl mx-auto min-h-[490px] rounded-2xl overflow-hidden mt-8">
              <iframe
